...
//float Tweak_N1 4384
//float4 Port_Value0_N000 4400
//float4 Port_Value1_N000 4416
...
float4 param_3=(*sc_set0.UserUniforms).Port_Value1_N000;
...
float4 l9_6=fast::max(param_8,float4(0.0));
float4 param_9=l9_6;
if (sc_ShaderCacheConstant_tmp!=0)
{
