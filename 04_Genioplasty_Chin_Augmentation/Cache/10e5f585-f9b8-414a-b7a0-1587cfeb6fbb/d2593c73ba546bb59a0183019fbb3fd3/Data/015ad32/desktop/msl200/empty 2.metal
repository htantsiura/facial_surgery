...
//float Tweak_N1 4384
//float4 activeColor 4400
//float4 Port_Value0_N000 4416
...
float param_1=0.0;
float4 param_2=(*sc_set0.UserUniforms).Port_Value0_N000;
...
float4 l9_4=(*sc_set0.UserUniforms).activeColor;
l9_3=l9_4;
param_3=l9_3;
param_6=param_3;
}
...
float4 l9_8=fast::max(param_8,float4(0.0));
float4 param_9=l9_8;
if (sc_ShaderCacheConstant_tmp!=0)
{
