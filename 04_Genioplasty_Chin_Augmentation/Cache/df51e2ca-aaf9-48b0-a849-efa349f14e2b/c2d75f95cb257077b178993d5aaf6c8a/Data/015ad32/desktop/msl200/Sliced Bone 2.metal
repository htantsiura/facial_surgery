...
float4 l9_17=(*sc_set0.UserUniforms).backColor;
l9_16=l9_17;
param_3=l9_16;
param_4=param_3;
}
...
{
if (l9_18<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_20=floor(mod(l9_19.xy,float2(4.0)));
float l9_21=(mod(dot(l9_20,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_18<l9_21)
{
discard_fragment();
}
...
float4 l9_32=fast::max(param_25,float4(0.0));
float4 param_26=l9_32;
if (sc_ShaderCacheConstant_tmp!=0)
{
