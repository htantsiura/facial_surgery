...
//float3x3 sTextureTransform 4304
//float4 sTextureUvMinMax 4352
//float4 sTextureBorderColor 4368
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sTexture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sTexture 73 -1
//spec_const int intensityTextureLayout 74 0
//spec_const int sTextureLayout 75 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_sTexture [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_sTexture [[function_constant(73)]];
...
constant int sTextureLayout [[function_constant(75)]];
...
param_2.y=l9_51;
l9_7=l9_54;
float2 l9_62=param_2;
int l9_63=param;
int l9_64=param_1;
float l9_65=param_10;
float2 l9_66=l9_62;
int l9_67=l9_63;
int l9_68=l9_64;
...
float3 l9_70=l9_69;
float3 l9_71=l9_70;
float4 l9_72=sc_set0.sTexture.sample(sc_set0.sTextureSmpSC,l9_71.xy,bias(l9_65));
float4 l9_73=l9_72;
if (param_8)
{
l9_73=mix(param_9,l9_73,float4(l9_7));
}
float4 l9_74=l9_73;
Output_N0=l9_74;
...
float2 l9_76=floor(mod(l9_75.xy,float2(4.0)));
float l9_77=(mod(dot(l9_76,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_11<l9_77)
{
discard_fragment();
}
...
{
l9_80=fast::clamp(l9_79.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_80=fast::clamp(dot(l9_79.xyz,float3(l9_79.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_80=(1.0-dot(l9_79.xyz,float3(0.33333001)))*l9_79.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_80=(1.0-fast::clamp(dot(l9_79.xyz,float3(1.0)),0.0,1.0))*l9_79.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_80=fast::clamp(dot(l9_79.xyz,float3(1.0)),0.0,1.0)*l9_79.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_80=fast::clamp(dot(l9_79.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_80=dot(l9_79.xyz,float3(0.33333001))*l9_79.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_80=1.0-fast::clamp(dot(l9_79.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_81=l9_80;
float l9_82=l9_81;
float l9_83=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_82;
float3 l9_84=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_78.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_85=float4(l9_84.x,l9_84.y,l9_84.z,l9_83);
param_12=l9_85;
}
else
{
...
int l9_96=l9_95;
int l9_97=l9_96;
float3 l9_98=float3(l9_92,0.0);
int l9_99=l9_94;
int l9_100=l9_97;
if (l9_99==1)
{
l9_98.y=((2.0*l9_98.y)+float(l9_100))-1.0;
}
float2 l9_101=l9_98.xy;
l9_93=l9_101;
}
else
{
...
int l9_112=l9_107;
float2 l9_113=l9_105;
int l9_114=sc_ScreenTextureLayout_tmp;
int l9_115=l9_112;
float l9_116=l9_106;
...
float4 l9_123=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_122.xy,bias(l9_116));
float4 l9_124=l9_123;
float4 l9_125=l9_124;
l9_88=l9_125;
}
float4 l9_126=l9_88;
float3 l9_127=l9_126.xyz;
float3 l9_128=l9_127;
float3 l9_129=l9_86.xyz;
float3 l9_130=definedBlend(l9_128,l9_129,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_87=float4(l9_130.x,l9_130.y,l9_130.z,l9_87.w);
float3 l9_131=mix(l9_127,l9_87.xyz,float3(l9_86.w));
l9_87=float4(l9_131.x,l9_131.y,l9_131.z,l9_87.w);
l9_87.w=1.0;
float4 l9_132=l9_87;
param_12=l9_132;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_133=float4(in.varScreenPos.xyz,1.0);
param_12=l9_133;
}
else
{
...
float l9_135=fast::clamp(abs(l9_134.z),0.0,1.0);
float4 l9_136=float4(l9_135,1.0-l9_135,1.0,1.0);
param_12=l9_136;
}
else
{
float4 l9_137=param_12;
float4 l9_138=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_138=float4(mix(float3(1.0),l9_137.xyz,float3(l9_137.w)),l9_137.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_139=l9_137.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_139=fast::clamp(l9_139,0.0,1.0);
}
l9_138=float4(l9_137.xyz*l9_139,l9_139);
}
else
{
l9_138=l9_137;
...
float4 l9_144=param_14;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_144.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_144;
return out;
}
} // FRAGMENT SHADER
