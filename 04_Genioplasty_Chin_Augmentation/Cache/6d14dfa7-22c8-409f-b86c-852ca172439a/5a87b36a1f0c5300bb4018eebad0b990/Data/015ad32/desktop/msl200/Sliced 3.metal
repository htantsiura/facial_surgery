...
float4 param_1=(*sc_set0.UserUniforms).backColor;
Output_N26=param_1;
...
Globals.SurfacePosition_ObjectSpace=((*sc_set0.UserUniforms).sc_ModelMatrixInverse*float4(in.varPosAndMotion.xyz,1.0)).xyz;
float4 Output_N26=float4(0.0);
float4 param=(*sc_set0.UserUniforms).backColor;
Output_N26=param;
float3 Output_N19=float3(0.0);
