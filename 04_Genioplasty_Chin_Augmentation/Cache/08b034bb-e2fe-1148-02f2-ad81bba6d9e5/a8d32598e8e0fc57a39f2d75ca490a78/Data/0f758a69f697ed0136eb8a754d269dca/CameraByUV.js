...
var __selfType = requireType("./CameraByUV");
...
let NewScript = (() => {
    ...
    var NewScript = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.cameraRootPTM = this.cameraRootPTM;
            this.cameraMoveSlider = this.cameraMoveSlider;
            this.uCoord = this.uCoord;
            this.vCoord = this.vCoord;
        }
        __initialize() {
            super.__initialize();
            this.cameraRootPTM = this.cameraRootPTM;
        ...
        onAwake() {
            let newCoords = new vec2(0.5, 0.5);
...
//# sourceMappingURL=CameraByUV.js.map