...
//float Port_Threshold_N007 4512
//float depthRef 4516
//}
...
float param_13=(*sc_set0.UserUniforms).Port_Threshold_N007;
...
float4 l9_79=fast::max(param_16,float4(0.0));
float4 param_17=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
