...
//float Tweak_N10 4512
//float4 Port_Input0_N012 4528
//float depthRef 4544
//}
...
float param_12=(*sc_set0.UserUniforms).Tweak_N10;
Output_N10=param_12;
float4 Output_N11=float4(0.0);
float4 param_13=Output_N1;
float param_14=Output_N10;
float4 param_15=param_13;
if (param_13.y<param_14)
{
discard_fragment();
}
Output_N11=param_15;
float4 Output_N12=float4(0.0);
Output_N12=(*sc_set0.UserUniforms).Port_Input0_N012+Output_N11;
...
float4 l9_79=fast::max(param_17,float4(0.0));
float4 param_18=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
