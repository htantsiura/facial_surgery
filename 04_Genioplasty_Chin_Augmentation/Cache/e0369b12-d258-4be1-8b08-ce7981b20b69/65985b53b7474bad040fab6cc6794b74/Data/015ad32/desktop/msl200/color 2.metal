...
//float3x3 Tweak_N1Transform 4432
//float4 Tweak_N1UvMinMax 4480
//float4 Tweak_N1BorderColor 4496
//float Tweak_N9 4512
//float Tweak_N10 4516
//float Port_Value4_N015 4520
//float4 Port_Input1_N017 4528
//float4 Port_Input2_N017 4544
//float depthRef 4560
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N1 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N1 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N1HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int Tweak_N1Layout 75 0
...
float Tweak_N9;
float Tweak_N10;
float Port_Value4_N015;
float4 Port_Input1_N017;
float4 Port_Input2_N017;
float depthRef;
};
struct sc_Bone_t
{
...
int l9_6=l9_1;
int param_1=Tweak_N1Layout_tmp;
int param_2=l9_6;
float2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N1_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N1Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N1_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).Tweak_N1UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N1BorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
Output_N1=l9_75;
float Value3_N3=0.0;
float4 param_12=Output_N1;
float param_13=param_12.z;
Value3_N3=param_13;
float4 Value_N15=float4(0.0);
Value_N15.x=Value3_N3;
Value_N15.y=Value3_N3;
Value_N15.z=Value3_N3;
Value_N15.w=(*sc_set0.UserUniforms).Port_Value4_N015;
float Output_N9=0.0;
float param_14=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_14;
float4 Output_N7=float4(0.0);
float4 param_15=Output_N1;
...
float param_18=(*sc_set0.UserUniforms).Tweak_N10;
Output_N10=param_18;
float4 Output_N11=float4(0.0);
float4 param_19=Output_N1;
float param_20=Output_N10;
float4 param_21=param_19;
if (param_19.y<param_20)
{
discard_fragment();
}
Output_N11=param_21;
float4 Output_N12=float4(0.0);
Output_N12=Output_N7+Output_N11;
float4 Output_N14=float4(0.0);
Output_N14=Value_N15+Output_N12;
float4 Output_N17=float4(0.0);
Output_N17=fast::clamp(Output_N14+float4(0.001),(*sc_set0.UserUniforms).Port_Input1_N017+float4(0.001),(*sc_set0.UserUniforms).Port_Input2_N017+float4(0.001))-float4(0.001);
...
{
float4 l9_76=gl_FragCoord;
float2 l9_77=floor(mod(l9_76.xy,float2(4.0)));
float l9_78=(mod(dot(l9_77,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_22<l9_78)
{
discard_fragment();
}
...
float4 l9_79=fast::max(param_23,float4(0.0));
float4 param_24=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_82=fast::clamp(l9_81.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_82=fast::clamp(dot(l9_81.xyz,float3(l9_81.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_82=(1.0-dot(l9_81.xyz,float3(0.33333001)))*l9_81.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_82=(1.0-fast::clamp(dot(l9_81.xyz,float3(1.0)),0.0,1.0))*l9_81.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_82=fast::clamp(dot(l9_81.xyz,float3(1.0)),0.0,1.0)*l9_81.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_82=fast::clamp(dot(l9_81.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_82=dot(l9_81.xyz,float3(0.33333001))*l9_81.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_82=1.0-fast::clamp(dot(l9_81.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_83=l9_82;
float l9_84=l9_83;
float l9_85=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_84;
float3 l9_86=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_80.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_87=float4(l9_86.x,l9_86.y,l9_86.z,l9_85);
param_25=l9_87;
}
else
{
...
{
float4 l9_91=out.sc_FragData0;
l9_90=l9_91;
}
else
{
float4 l9_92=gl_FragCoord;
float2 l9_93=l9_92.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_94=l9_93;
...
int l9_98=l9_97;
int l9_99=l9_98;
float3 l9_100=float3(l9_94,0.0);
int l9_101=l9_96;
int l9_102=l9_99;
if (l9_101==1)
{
l9_100.y=((2.0*l9_100.y)+float(l9_102))-1.0;
}
float2 l9_103=l9_100.xy;
l9_95=l9_103;
}
else
{
...
int l9_114=l9_109;
float2 l9_115=l9_107;
int l9_116=sc_ScreenTextureLayout_tmp;
int l9_117=l9_114;
float l9_118=l9_108;
float2 l9_119=l9_115;
int l9_120=l9_116;
int l9_121=l9_117;
float3 l9_122=float3(0.0);
if (l9_120==0)
{
l9_122=float3(l9_119,0.0);
}
else
{
if (l9_120==1)
{
l9_122=float3(l9_119.x,(l9_119.y*0.5)+(0.5-(float(l9_121)*0.5)),0.0);
}
else
{
l9_122=float3(l9_119,float(l9_121));
}
}
float3 l9_123=l9_122;
float3 l9_124=l9_123;
float4 l9_125=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_124.xy,bias(l9_118));
float4 l9_126=l9_125;
float4 l9_127=l9_126;
l9_90=l9_127;
}
float4 l9_128=l9_90;
float3 l9_129=l9_128.xyz;
float3 l9_130=l9_129;
float3 l9_131=l9_88.xyz;
float3 l9_132=definedBlend(l9_130,l9_131,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_89=float4(l9_132.x,l9_132.y,l9_132.z,l9_89.w);
float3 l9_133=mix(l9_129,l9_89.xyz,float3(l9_88.w));
l9_89=float4(l9_133.x,l9_133.y,l9_133.z,l9_89.w);
l9_89.w=1.0;
float4 l9_134=l9_89;
param_25=l9_134;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_135=float4(in.varScreenPos.xyz,1.0);
param_25=l9_135;
}
else
{
...
float l9_137=fast::clamp(abs(l9_136.z),0.0,1.0);
float4 l9_138=float4(l9_137,1.0-l9_137,1.0,1.0);
param_25=l9_138;
}
else
{
float4 l9_139=param_25;
float4 l9_140=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_140=float4(mix(float3(1.0),l9_139.xyz,float3(l9_139.w)),l9_139.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_141=l9_139.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_141=fast::clamp(l9_141,0.0,1.0);
}
l9_140=float4(l9_139.xyz*l9_141,l9_141);
}
else
{
l9_140=l9_139;
