...
//float4 Tweak_N21 4528
//float4 Port_Input2_N012 4544
//float4 Port_Input1_N020 4560
//float depthRef 4576
//}
...
float4 param_20=(*sc_set0.UserUniforms).Tweak_N21;
Output_N21=param_20;
float4 Output_N18=float4(0.0);
Output_N18=Output_N20*Output_N21;
...
float4 l9_79=fast::max(param_22,float4(0.0));
float4 param_23=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
