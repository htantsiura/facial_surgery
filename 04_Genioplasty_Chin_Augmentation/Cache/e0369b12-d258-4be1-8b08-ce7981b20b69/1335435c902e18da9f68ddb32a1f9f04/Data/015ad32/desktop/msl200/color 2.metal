...
//}
//ubo int UserUniforms 0:33:4592 {
//float4 sc_Time 1376
...
//float4 Port_Input2_N012 4528
//float4 Port_Input1_N020 4544
//float4 Port_Input1_N018 4560
//float depthRef 4576
//}
...
float Tweak_N9;
float Tweak_N10;
float4 Port_Input2_N012;
float4 Port_Input1_N020;
float4 Port_Input1_N018;
float depthRef;
};
struct sc_Bone_t
{
...
Output_N1=l9_75;
float Output_N9=0.0;
float param_12=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_12;
float4 Output_N7=float4(0.0);
float4 param_13=Output_N1;
float param_14=Output_N9;
float4 param_15=param_13;
...
float param_16=(*sc_set0.UserUniforms).Tweak_N10;
Output_N10=param_16;
float4 Output_N11=float4(0.0);
float4 param_17=Output_N1;
float param_18=Output_N10;
float4 param_19=param_17;
if (param_17.y<param_18)
{
discard_fragment();
}
Output_N11=param_19;
float4 Output_N12=float4(0.0);
Output_N12=(Output_N7+Output_N11)+(*sc_set0.UserUniforms).Port_Input2_N012;
float4 Output_N20=float4(0.0);
Output_N20=Output_N12+(*sc_set0.UserUniforms).Port_Input1_N020;
float4 Output_N18=float4(0.0);
Output_N18=Output_N20*(*sc_set0.UserUniforms).Port_Input1_N018;
FinalColor=Output_N18;
float param_20=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_20<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_79=fast::max(param_21,float4(0.0));
float4 param_22=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
