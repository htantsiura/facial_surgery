...
float param_20=(*sc_set0.UserUniforms).Tweak_N18;
Output_N18=param_20;
float4 Output_N19=float4(0.0);
float4 param_21=Output_N1;
float param_22=Output_N18;
float4 param_23=param_21;
if (param_21.z<param_22)
{
discard_fragment();
}
Output_N19=param_23;
float4 Output_N12=float4(0.0);
Output_N12=(Output_N7+Output_N11)+Output_N19;
...
float4 l9_79=fast::max(param_25,float4(0.0));
float4 param_26=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
