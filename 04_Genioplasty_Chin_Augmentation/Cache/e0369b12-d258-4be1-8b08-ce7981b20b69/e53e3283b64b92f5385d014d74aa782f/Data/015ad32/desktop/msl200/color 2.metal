...
Output_N17=fast::clamp(Value_N15+float4(0.001),(*sc_set0.UserUniforms).Port_Input1_N017+float4(0.001),(*sc_set0.UserUniforms).Port_Input2_N017+float4(0.001))-float4(0.001);
float4 Output_N14=float4(0.0);
Output_N14=Output_N1+Output_N17;
float Output_N9=0.0;
float param_14=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_14;
float4 Output_N7=float4(0.0);
float4 param_15=Output_N14;
