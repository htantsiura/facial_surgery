...
//float3x3 screenTexTransform 4448
//float4 screenTexUvMinMax 4496
//float4 screenTexBorderColor 4512
//float2 impulseRange 4528
//float4x4 fluidGeoMat 4544
//float4x4 fluidGeoMatInv 4608
//float fluidGeoBboxDim 4672
//float3 locatorPos 4688
//float3 locatorPosPrev 4704
//float timeMult 4736
//float touchRadius 4740
//bool speedToRadius 4744
//float speedScale 4748
//float softness 4752
//float velocityMult 4756
//float depthRef 4764
//}
...
float2 impulseRange;
float aspectRatio;
float4x4 fluidGeoMat;
float4x4 fluidGeoMatInv;
float fluidGeoBboxDim;
float3 locatorPos;
float3 locatorPosPrev;
float2 touchPosition;
float2 touchPositionPrev;
float timeMult;
float touchRadius;
int speedToRadius;
float speedScale;
...
{
main_frag_out out={};
bool N81_speedToRadius=false;
float2 N81_impulseRange=float2(0.0);
float N81_fluidGeoBboxDim=0.0;
float3 N81_locatorPos=float3(0.0);
float3 N81_locatorPosPrev=float3(0.0);
float N81_timeMult=0.0;
float N81_touchRadius=0.0;
float N81_speedScale=0.0;
float N81_softness=0.0;
float N81_velocityMult=0.0;
float4 N81_impulseOut=float4(0.0);
...
Output_N86=param_1;
float4x4 Output_N2=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
float4x4 param_2=(*sc_set0.UserUniforms).fluidGeoMat;
Output_N2=param_2;
float4x4 Output_N7=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
float4x4 param_3=(*sc_set0.UserUniforms).fluidGeoMatInv;
Output_N7=param_3;
float Output_N9=0.0;
float param_4=(*sc_set0.UserUniforms).fluidGeoBboxDim;
Output_N9=param_4;
float3 Output_N0=float3(0.0);
float3 param_5=(*sc_set0.UserUniforms).locatorPos;
Output_N0=param_5;
float3 Output_N8=float3(0.0);
float3 param_6=(*sc_set0.UserUniforms).locatorPosPrev;
Output_N8=param_6;
float Output_N80=0.0;
float param_7=(*sc_set0.UserUniforms).timeMult;
Output_N80=param_7;
float Output_N3=0.0;
float param_8=(*sc_set0.UserUniforms).touchRadius;
Output_N3=param_8;
float Output_N73=0.0;
float param_9=float((*sc_set0.UserUniforms).speedToRadius!=0);
Output_N73=param_9;
float Output_N78=0.0;
float param_10=(*sc_set0.UserUniforms).speedScale;
Output_N78=param_10;
float Output_N12=0.0;
float param_11=(*sc_set0.UserUniforms).softness;
Output_N12=param_11;
float Output_N74=0.0;
float param_12=(*sc_set0.UserUniforms).velocityMult;
Output_N74=param_12;
float4 impulseOut_N81=float4(0.0);
float2 param_13=Output_N86;
float4x4 param_14=Output_N2;
float4x4 param_15=Output_N7;
float param_16=Output_N9;
float3 param_17=Output_N0;
float3 param_18=Output_N8;
float param_19=Output_N80;
float param_20=Output_N3;
float param_21=Output_N73;
float param_22=Output_N78;
float param_23=Output_N12;
float param_24=Output_N74;
ssGlobals param_26=Globals;
ssGlobals tempGlobals=param_26;
float4 param_25=float4(0.0);
N81_impulseRange=param_13;
float4x4 N81_fluidGeoMat=param_14;
float4x4 N81_fluidGeoMatInv=param_15;
N81_fluidGeoBboxDim=param_16;
N81_locatorPos=param_17;
N81_locatorPosPrev=param_18;
N81_timeMult=param_19;
N81_touchRadius=param_20;
N81_speedToRadius=param_21!=0.0;
N81_speedScale=param_22;
N81_softness=param_23;
N81_velocityMult=param_24;
float2 l9_1=tempGlobals.Surface_UVCoord0;
float2 l9_2=l9_1;
float2 l9_3=l9_2;
...
int l9_10=l9_5;
int l9_11=screenTexLayout_tmp;
int l9_12=l9_10;
float2 l9_13=l9_3;
bool l9_14=(int(SC_USE_UV_TRANSFORM_screenTex_tmp)!=0);
float3x3 l9_15=(*sc_set0.UserUniforms).screenTexTransform;
int2 l9_16=int2(SC_SOFTWARE_WRAP_MODE_U_screenTex_tmp,SC_SOFTWARE_WRAP_MODE_V_screenTex_tmp);
bool l9_17=(int(SC_USE_UV_MIN_MAX_screenTex_tmp)!=0);
float4 l9_18=(*sc_set0.UserUniforms).screenTexUvMinMax;
bool l9_19=(int(SC_USE_CLAMP_TO_BORDER_screenTex_tmp)!=0);
float4 l9_20=(*sc_set0.UserUniforms).screenTexBorderColor;
float l9_21=0.0;
bool l9_22=l9_19&&(!l9_17);
float l9_23=1.0;
float l9_24=l9_13.x;
int l9_25=l9_16.x;
if (l9_25==1)
...
float2 l9_52=l9_13;
bool l9_53=l9_14;
float3x3 l9_54=l9_15;
if (l9_53)
{
l9_52=float2((l9_54*float3(l9_52,1.0)).xy);
}
float2 l9_55=l9_52;
l9_13=l9_55;
float l9_56=l9_13.x;
...
float3 l9_86=l9_85;
float3 l9_87=l9_86;
float4 l9_88=sc_set0.screenTex.sample(sc_set0.screenTexSmpSC,l9_87.xy,bias(l9_81));
float4 l9_89=l9_88;
if (l9_19)
{
l9_89=mix(l9_20,l9_89,float4(l9_23));
}
float4 l9_90=l9_89;
l9_4=l9_90;
float4 l9_91=l9_4;
...
float l9_94=N81_impulseRange.x;
float l9_95=N81_impulseRange.y;
float l9_96=0.0;
float2 l9_97=l9_93;
float l9_98=l9_94;
float l9_99=l9_95;
...
#if (1)
{
l9_101=floor((l9_101*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_102=dot(l9_101,float2(1.0,0.0039215689));
float l9_103=l9_102;
float l9_104=0.0;
float l9_105=l9_100;
float l9_106=l9_98;
...
float l9_110=l9_96;
float l9_111=l9_110;
float2 l9_112=l9_92.zw;
float l9_113=N81_impulseRange.x;
float l9_114=N81_impulseRange.y;
float l9_115=0.0;
...
#if (1)
{
l9_120=floor((l9_120*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_121=dot(l9_120,float2(1.0,0.0039215689));
float l9_122=l9_121;
float l9_123=0.0;
float l9_124=l9_119;
float l9_125=l9_117;
...
l9_115=l9_128;
float l9_129=l9_115;
float2 l9_130=float2(l9_111,l9_129);
float3 l9_131=N81_locatorPos;
float3 l9_132=N81_locatorPosPrev;
float l9_133=tempGlobals.gTimeDelta;
float3 l9_134=(l9_131-l9_132)/float3(N81_timeMult*l9_133);
float4 l9_135=N81_fluidGeoMat*float4(((l9_2*2.0)-float2(1.0))*N81_fluidGeoBboxDim,0.0,1.0);
float l9_136;
if (N81_speedToRadius)
{
l9_136=(length(l9_134+float3(9.9999997e-06))*N81_speedScale)*0.001;
}
else
{
l9_136=0.0;
...
float l9_137=l9_136;
l9_137=fast::max(l9_137,9.9999997e-06);
float l9_138=1.0-fast::clamp(N81_touchRadius+l9_137,0.0,1.0);
float l9_139=fast::clamp(distance(l9_135.xyz,l9_131),0.0,N81_fluidGeoBboxDim+10.0);
l9_139=1.0-(l9_139/(N81_fluidGeoBboxDim+10.0));
l9_139=smoothstep(l9_138,mix(l9_138,1.0,N81_softness*2.0),l9_139);
l9_134*=((N81_velocityMult*l9_139)*1.0);
float3x3 l9_140;
l9_140[0]=N81_fluidGeoMatInv[0].xyz;
l9_140[1]=N81_fluidGeoMatInv[1].xyz;
l9_140[2]=N81_fluidGeoMatInv[2].xyz;
l9_134=l9_140*l9_134;
l9_130+=l9_134.xy;
float l9_141=l9_130.x;
float l9_142=N81_impulseRange.x;
float l9_143=N81_impulseRange.y;
float2 l9_144=float2(0.0);
float l9_145=l9_141;
float l9_146=l9_142;
float l9_147=l9_143;
float l9_148=0.99998999;
float l9_149=fast::clamp(l9_145,l9_146,l9_147);
float l9_150=l9_146;
float l9_151=l9_147;
float l9_152=0.0;
float l9_153=l9_148;
...
float l9_155=l9_154;
float4 l9_156=float4(1.0,255.0,65025.0,16581375.0)*l9_155;
l9_156=fract(l9_156);
l9_156-=(l9_156.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_157=l9_156.xy;
float2 l9_158=l9_157;
l9_144=l9_158;
float2 l9_159=l9_144;
float l9_160=l9_130.y;
float l9_161=N81_impulseRange.x;
float l9_162=N81_impulseRange.y;
float2 l9_163=float2(0.0);
float l9_164=l9_160;
float l9_165=l9_161;
float l9_166=l9_162;
float l9_167=0.99998999;
float l9_168=fast::clamp(l9_164,l9_165,l9_166);
float l9_169=l9_165;
float l9_170=l9_166;
float l9_171=0.0;
float l9_172=l9_167;
...
float l9_174=l9_173;
float4 l9_175=float4(1.0,255.0,65025.0,16581375.0)*l9_174;
l9_175=fract(l9_175);
l9_175-=(l9_175.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_176=l9_175.xy;
float2 l9_177=l9_176;
l9_163=l9_177;
float2 l9_178=l9_163;
N81_impulseOut=float4(l9_159,l9_178);
param_25=N81_impulseOut;
impulseOut_N81=param_25;
FinalColor=impulseOut_N81;
...
{
float4 l9_179=gl_FragCoord;
float2 l9_180=floor(mod(l9_179.xy,float2(4.0)));
float l9_181=(mod(dot(l9_180,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_27<l9_181)
{
discard_fragment();
}
...
float4 l9_182=fast::max(param_28,float4(0.0));
float4 param_29=l9_182;
if (sc_ShaderCacheConstant_tmp!=0)
{
