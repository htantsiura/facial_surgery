...
var __selfType = requireType("./toOrigin");
...
let NewScript = (() => {
    ...
    var NewScript = _classThis = class extends _classSuper {
        ...
        buttonToOrigin() {
            ...
            this.scaleSlider.updateCurrentValue(0.5, true);
        }
        tweenRotFunc(transform, quaternion, t) {
            LSTween_1.LSTween.rotateToLocal(transform, quaternion, t)
                .easing(Easing_1.default.Quadratic.Out)
                .start();
        }
        tweenMoveFunc(transform, pos, t) {
            LSTween_1.LSTween.moveToLocal(transform, pos, t)
                .easing(Easing_1.default.Quadratic.Out)
                .start();
        }
        tweenScaleFunc(transform, scale, t) {
            LSTween_1.LSTween.scaleToLocal(transform, scale, t)
                .easing(Easing_1.default.Quadratic.Out)
                .start();
        }
    };
...
//# sourceMappingURL=toOrigin.js.map