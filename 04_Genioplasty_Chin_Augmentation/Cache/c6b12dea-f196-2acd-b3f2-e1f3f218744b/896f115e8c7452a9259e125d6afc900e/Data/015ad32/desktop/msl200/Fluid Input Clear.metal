...
//}
//ubo int UserUniforms 0:31:4416 {
...
//float Port_Value1_N000 4384
//float Port_Min1_N000 4388
//float Port_Max1_N000 4392
//float Port_Value2_N000 4396
//float Port_Min2_N000 4400
//float Port_Max2_N000 4404
//float depthRef 4408
//}
...
float Port_Value1_N000;
float Port_Min1_N000;
float Port_Max1_N000;
float Port_Value2_N000;
float Port_Min2_N000;
float Port_Max2_N000;
float depthRef;
};
struct sc_Bone_t
{
...
float4 Packed_N0=float4(0.0);
float param_1=(*sc_set0.UserUniforms).Port_Value1_N000;
float param_2=(*sc_set0.UserUniforms).Port_Min1_N000;
float param_3=(*sc_set0.UserUniforms).Port_Max1_N000;
float param_4=(*sc_set0.UserUniforms).Port_Value2_N000;
float param_5=(*sc_set0.UserUniforms).Port_Min2_N000;
float param_6=(*sc_set0.UserUniforms).Port_Max2_N000;
float l9_1=param_1;
float l9_2=param_2;
float l9_3=param_3;
float l9_4=0.99998999;
float l9_5=fast::clamp(l9_1,l9_2,l9_3);
float l9_6=l9_2;
float l9_7=l9_3;
float l9_8=0.0;
float l9_9=l9_4;
float l9_10=l9_8+(((l9_5-l9_6)*(l9_9-l9_8))/(l9_7-l9_6));
float l9_11=l9_10;
float4 l9_12=float4(1.0,255.0,65025.0,16581375.0)*l9_11;
l9_12=fract(l9_12);
l9_12-=(l9_12.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_13=l9_12.xy;
float2 l9_14=l9_13;
float4 param_7;
param_7=float4(l9_14.x,l9_14.y,param_7.z,param_7.w);
float l9_15=param_4;
float l9_16=param_5;
float l9_17=param_6;
float l9_18=0.99998999;
float l9_19=fast::clamp(l9_15,l9_16,l9_17);
float l9_20=l9_16;
float l9_21=l9_17;
float l9_22=0.0;
float l9_23=l9_18;
float l9_24=l9_22+(((l9_19-l9_20)*(l9_23-l9_22))/(l9_21-l9_20));
float l9_25=l9_24;
float4 l9_26=float4(1.0,255.0,65025.0,16581375.0)*l9_25;
l9_26=fract(l9_26);
l9_26-=(l9_26.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float2 l9_27=l9_26.xy;
float2 l9_28=l9_27;
param_7=float4(param_7.x,param_7.y,l9_28.x,l9_28.y);
Packed_N0=param_7;
FinalColor=Packed_N0;
...
{
float4 l9_29=gl_FragCoord;
float2 l9_30=floor(mod(l9_29.xy,float2(4.0)));
float l9_31=(mod(dot(l9_30,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_8<l9_31)
{
discard_fragment();
}
