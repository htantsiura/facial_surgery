...
Output_N13=float(Output_N50>=Output_N2);
float4 Output_N51=float4(0.0);
float4 param_23=Output_N18;
float param_24=Output_N13;
float4 param_25=param_23;
if (param_23.x<param_24)
{
discard_fragment();
}
Output_N51=param_25;
float4 Output_N52=float4(0.0);
Output_N52=Output_N7*Output_N51;
FinalColor=Output_N52;
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
...
float4 l9_78=fast::max(param_26,float4(0.0));
float4 param_27=l9_78;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_27.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=param_27;
return out;
}
float4 param_28=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_79=param_28;
float4 l9_80=l9_79;
float l9_81=1.0;
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_29,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_30=FinalColor;
float4 l9_145=param_30;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float Output_N13=0.0;
Output_N13=float(Output_N50>=Output_N2);
float4 param_11=Output_N18;
float param_12=Output_N13;
if (param_11.x<param_12)
{
discard_fragment();
}
return out;
