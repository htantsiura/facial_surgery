...
Output_N32=float(Output_N1>=(*sc_set0.UserUniforms).Port_Input1_N032);
float4 Output_N7=float4(0.0);
float4 param_19=Output_N18;
float param_20=Output_N32;
...
float4 l9_78=fast::max(param_22,float4(0.0));
float4 param_23=l9_78;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float Output_N32=0.0;
Output_N32=float(Output_N1>=(*sc_set0.UserUniforms).Port_Input1_N032);
float4 param_8=Output_N18;
float param_9=Output_N32;
if (param_8.x<param_9)
{
discard_fragment();
}
return out;
