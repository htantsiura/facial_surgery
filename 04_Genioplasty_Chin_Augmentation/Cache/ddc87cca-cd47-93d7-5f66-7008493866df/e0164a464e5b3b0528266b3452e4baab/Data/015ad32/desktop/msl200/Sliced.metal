...
//float Port_Input1_N013 4752
//float Port_Input2_N013 4756
//float depthRef 4760
//}
...
Output_N13=(Output_N2+(*sc_set0.UserUniforms).Port_Input1_N013)+(*sc_set0.UserUniforms).Port_Input2_N013;
...
float4 l9_24=fast::max(param_23,float4(0.0));
float4 param_24=l9_24;
if (sc_ShaderCacheConstant_tmp!=0)
{
