...
//float Port_Input0_N024 4752
//float4 Port_Input0_N015 4768
//float depthRef 4784
//}
...
Output_N17=Output_N30/(Output_N24+1.234e-06);
...
Output_N15=cos((*sc_set0.UserUniforms).Port_Input0_N015);
float4 Output_N20=float4(0.0);
Output_N20=Output_N15/(float4(Output_N24)+float4(1.234e-06));
float3 Output_N16=float3(0.0);
Output_N16=Output_N19*Output_N20.xyz;
