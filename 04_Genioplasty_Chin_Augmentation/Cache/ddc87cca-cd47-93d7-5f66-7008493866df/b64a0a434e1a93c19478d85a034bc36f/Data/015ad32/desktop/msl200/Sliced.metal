...
//float Port_Input1_N017 4752
//float4 Port_Input2_N013 4768
//float depthRef 4784
//}
...
Output_N17=Output_N30/((*sc_set0.UserUniforms).Port_Input1_N017+1.234e-06);
float3 Output_N11=float3(0.0);
Output_N11=Output_N19*float3(Output_N17);
float Output_N12=0.0;
Output_N12=Output_N11.y;
float4 Output_N13=float4(0.0);
Output_N13=(float4(Output_N2)+float4(Output_N12))+(*sc_set0.UserUniforms).Port_Input2_N013;
...
float4 param_21=Output_N18;
float param_22=Output_N32.x;
float4 param_23=param_21;
if (param_21.x<param_22)
{
discard_fragment();
}
Output_N7=param_23;
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_27,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_28=FinalColor;
float4 l9_91=param_28;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 Output_N32=float4(0.0);
Output_N32=float4(float(Output_N1>=Output_N13.x),float(Output_N1>=Output_N13.y),float(Output_N1>=Output_N13.z),float(Output_N1>=Output_N13.w));
float4 param_10=Output_N18;
float param_11=Output_N32.x;
if (param_10.x<param_11)
{
discard_fragment();
}
return out;
