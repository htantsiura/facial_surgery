...
//float Tweak_N54 4660
//float Port_Opacity_N018 4664
//float3 Port_Emissive_N018 4688
//float Port_Metallic_N018 4704
//float Port_Input1_N023 4708
//float3 Port_AO_N018 4720
//float3 Port_SpecularAO_N018 4736
//float3 Port_Import_N049 4752
//float4 Port_Input1_N055 4784
//float4 Port_Input2_N055 4800
//float depthRef 4816
//}
...
float4 Port_Input1_N055;
float4 Port_Input2_N055;
float depthRef;
};
struct sc_Bone_t
{
...
Output_N50=Output_N19.x;
float Output_N54=0.0;
float param_23=(*sc_set0.UserUniforms).Tweak_N54;
Output_N54=param_23;
float Output_N13=0.0;
Output_N13=float(Output_N50>=Output_N54);
float4 Output_N51=float4(0.0);
float4 param_24=Output_N18;
float param_25=Output_N13;
float4 param_26=param_24;
if (param_24.x<param_25)
{
discard_fragment();
}
Output_N51=param_26;
float4 Output_N53=float4(0.0);
Output_N53=Output_N7+Output_N51;
float4 Output_N55=float4(0.0);
Output_N55=fast::clamp(Output_N53+float4(0.001),(*sc_set0.UserUniforms).Port_Input1_N055+float4(0.001),(*sc_set0.UserUniforms).Port_Input2_N055+float4(0.001))-float4(0.001);
FinalColor=Output_N55;
if ((*sc_set0.UserUniforms).sc_RayTracingCasterConfiguration.x!=0u)
{
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_30,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_31=FinalColor;
float4 l9_145=param_31;
if (sc_ShaderCacheConstant_tmp!=0)
{
