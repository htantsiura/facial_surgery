...
Output_N13=(float4(Output_N2)+float4(Output_N2))+(*sc_set0.UserUniforms).Port_Input2_N013;
float4 Output_N32=float4(0.0);
Output_N32=float4(float(Output_N1>=Output_N13.x),float(Output_N1>=Output_N13.y),float(Output_N1>=Output_N13.z),float(Output_N1>=Output_N13.w));
float4 Output_N7=float4(0.0);
float4 param_20=Output_N18;
float param_21=Output_N32.x;
