...
//float4 Port_Input1_N056 4784
//float4 Port_Input1_N052 4800
//float depthRef 4816
//}
...
float4 Port_Input1_N056;
float4 Port_Input1_N052;
float depthRef;
};
struct sc_Bone_t
{
...
Output_N56=Output_N7*(*sc_set0.UserUniforms).Port_Input1_N056;
...
Output_N52=Output_N51*(*sc_set0.UserUniforms).Port_Input1_N052;
float4 Output_N53=float4(0.0);
Output_N53=Output_N56+Output_N52;
