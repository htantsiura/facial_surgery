...
//sampler sampler Tweak_N0SmpSC 0:22
...
//texture texture2D Tweak_N0 0:4:0:22
...
//float zoom 4512
//float2 Port_Input1_N002 4520
//float2 Port_Input1_N003 4528
//float Port_RangeMinA_N007 4536
//float Port_RangeMaxA_N007 4540
//float Port_RangeMinB_N007 4544
//float Port_RangeMaxB_N007 4548
//float2 Port_Center_N008 4552
//float Port_Value2_N010 4560
//float depthRef 4564
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N0 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int Tweak_N0Layout 75 0
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N0 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N0 [[function_constant(35)]];
...
constant bool Tweak_N0HasSwappedViews [[function_constant(37)]];
...
Value_N10.w=(*sc_set0.UserUniforms).Port_Value2_N010;
FinalColor=Value_N10;
float param_13=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_13<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_17,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_18=FinalColor;
float4 l9_146=param_18;
if (sc_ShaderCacheConstant_tmp!=0)
{
