...
//float2 Port_Input1_N002 4512
//float2 Port_Input1_N003 4520
//float2 Port_Input1_N005 4528
//float2 Port_Input2_N005 4536
//float depthRef 4544
//}
...
float2 Port_Input1_N005;
float2 Port_Input2_N005;
float depthRef;
};
struct sc_Bone_t
{
...
Output_N5=(Output_N3*(*sc_set0.UserUniforms).Port_Input1_N005)+(*sc_set0.UserUniforms).Port_Input2_N005;
...
int l9_6=l9_1;
int param_1=Tweak_N0Layout_tmp;
int param_2=l9_6;
float2 param_3=Output_N5;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N0_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N0Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N0_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).Tweak_N0UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N0BorderColor;
float param_11=0.0;
...
float4 l9_79=fast::max(param_13,float4(0.0));
float4 param_14=l9_79;
if (sc_ShaderCacheConstant_tmp!=0)
{
