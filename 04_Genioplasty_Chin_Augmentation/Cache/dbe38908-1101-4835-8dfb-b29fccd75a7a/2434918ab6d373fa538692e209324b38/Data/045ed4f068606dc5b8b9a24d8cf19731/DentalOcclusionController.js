...
exports.DentalOcclusionController = void 0;
var __selfType = requireType("./DentalOcclusionController");
...
let DentalOcclusionController = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var DentalOcclusionController = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        onAwake() {
            ...
            this.createEvent("OnStartEvent").bind(() => {
                ...
                this.sliderX.onValueChange.add((value) => {
                    ...
                    // this.textX.text = "Position by X: " + ((value - 0.5) / 10).toFixed(4)
                });
                this.sliderY.onValueChange.add((value) => {
                    ...
                    teethTrf.setLocalPosition(newTeethPos);
                    let newSkullPos = this.newPositionBySlider("y", value, this._skullMandStartPos, this._skullMandCurrentPos);
                    skullMandibulaTrf.setLocalPosition(newSkullPos);
                    // this.textY.text = "Position by Y: " + ((value - 0.5) / 20).toFixed(4)
                });
                this.sliderZ.onValueChange.add((value) => {
                    ...
                    teethTrf.setLocalPosition(newTeethPos);
                    let newSkullPos = this.newPositionBySlider("z", value, this._skullMandStartPos, this._skullMandCurrentPos);
                    skullMandibulaTrf.setLocalPosition(newSkullPos);
                    // this.textZ.text = "Position by Z: " + ((value - 0.5) / 10).toFixed(4)
                });
            });
        }
        newPositionBySlider(slider, value, startPos, currentPos) {
            ...
            if (slider === "y") {
                newPos.y = startPos.y + (value - 0.5) / 20 * -1;
                currentPos.y = newPos.y;
                return newPos;
            }
            if (slider === "z") {
                newPos.z = startPos.z + (value - 0.5) / 10 * -1;
    ...
    __setFunctionName(_classThis, "DentalOcclusionController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        DentalOcclusionController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DentalOcclusionController = _classThis;
})();
exports.DentalOcclusionController = DentalOcclusionController;
//# sourceMappingURL=DentalOcclusionController.js.map