...
private _skullMandCurrentPos: vec3
    ...
    private newPositionBySlider(slider, value, startPos): vec3 {
        let newPos = new vec3(this._teethCurrentPos.x, this._teethCurrentPos.y, this._teethCurrentPos.z)
        if(slider === "x") {
        ...
        if(slider === "y") {
            newPos.y = startPos.y + (value - 0.5) / 10
