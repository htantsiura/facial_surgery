...
let PlaneBuilder = (() => {
    ...
    var PlaneBuilder = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.matToolPlane = this.matToolPlane;
            this.bone = this.bone;
        ...
        updateObjectParameters(isActive) {
            if (isActive) {
                ...
                this.matToolPlane.mainPass.isActive = 1;
                this.slicedMatInverted.mainPass.isActiveColor = 1;
                ...
                this.matToolPlane.mainPass.isActive = 0;
                this.slicedMatInverted.mainPass.isActiveColor = 0;
        ...
        objectInteractable(object, value) {
            object.getComponent(Interactable_1.Interactable.getTypeName()).enabled = value;
            object.getComponent(InteractableManipulation_1.InteractableManipulation.getTypeName()).enabled = value;
        }
        getStartPos() {
            this.p0 = this.point0.getTransform().getLocalPosition();
            this.p1 = this.point1.getTransform().getLocalPosition();
            this.p2 = this.point2.getTransform().getLocalPosition();
            this.startPos = [this.p0, this.p1, this.p2];
        }
        resetCutTool() {
            this.point0.getTransform().setLocalPosition(this.startPos[0]);
            this.point1.getTransform().setLocalPosition(this.startPos[1]);
            this.point2.getTransform().setLocalPosition(this.startPos[2]);
            this.rebuildMesh();
            this.alignObject();
            this.vectorsToShader();
        }
