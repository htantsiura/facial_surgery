...
//float2 pressureRange 4384
//float clearValue 4392
//int reset 4396
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sPressure 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sPressure 73 -1
//spec_const int intensityTextureLayout 74 0
//spec_const int sPressureLayout 75 0
...
constant bool SC_USE_CLAMP_TO_BORDER_sPressure [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_sPressure [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_sPressure [[function_constant(36)]];
...
constant bool sPressureHasSwappedViews [[function_constant(39)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_sPressure [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_sPressure [[function_constant(73)]];
...
constant int sPressureLayout [[function_constant(75)]];
...
main_frag_out out={};
int N1_reset=0;
float2 N1_pressureRange=float2(0.0);
float N1_clearValue=0.0;
float4 N1_pressureOut=float4(0.0);
...
Output_N5=param;
float Output_N3=0.0;
float param_1=(*sc_set0.UserUniforms).clearValue;
Output_N3=param_1;
float Output_N9=0.0;
float param_2=float((*sc_set0.UserUniforms).reset);
Output_N9=param_2;
float4 pressureOut_N1=float4(0.0);
float2 param_3=Output_N5;
float param_4=Output_N3;
float param_5=Output_N9;
ssGlobals param_7=Globals;
ssGlobals tempGlobals=param_7;
float4 param_6=float4(0.0);
N1_pressureRange=param_3;
N1_clearValue=param_4;
N1_reset=int(param_5);
...
int l9_9=l9_4;
int l9_10=sPressureLayout_tmp;
int l9_11=l9_9;
float2 l9_12=l9_2;
bool l9_13=(int(SC_USE_UV_TRANSFORM_sPressure_tmp)!=0);
float3x3 l9_14=(*sc_set0.UserUniforms).sPressureTransform;
int2 l9_15=int2(SC_SOFTWARE_WRAP_MODE_U_sPressure_tmp,SC_SOFTWARE_WRAP_MODE_V_sPressure_tmp);
bool l9_16=(int(SC_USE_UV_MIN_MAX_sPressure_tmp)!=0);
float4 l9_17=(*sc_set0.UserUniforms).sPressureUvMinMax;
bool l9_18=(int(SC_USE_CLAMP_TO_BORDER_sPressure_tmp)!=0);
float4 l9_19=(*sc_set0.UserUniforms).sPressureBorderColor;
float l9_20=0.0;
...
float3 l9_85=l9_84;
float3 l9_86=l9_85;
float4 l9_87=sc_set0.sPressure.sample(sc_set0.sPressureSmpSC,l9_86.xy,bias(l9_80));
float4 l9_88=l9_87;
if (l9_18)
{
...
float4 l9_90=l9_3;
float4 l9_91=l9_90;
float l9_92=N1_pressureRange.x;
float l9_93=N1_pressureRange.y;
float l9_94=0.0;
float4 l9_95=l9_91;
float l9_96=l9_92;
float l9_97=l9_93;
float l9_98=0.99998999;
float4 l9_99=l9_95;
#if (1)
{
l9_99=floor((l9_99*255.0)+float4(0.5))/float4(255.0);
}
#endif
float l9_100=dot(l9_99,float4(1.0,0.0039215689,1.53787e-05,6.0308629e-08));
float l9_101=l9_100;
float l9_102=0.0;
float l9_103=l9_98;
float l9_104=l9_96;
float l9_105=l9_97;
float l9_106=l9_104+(((l9_101-l9_102)*(l9_105-l9_104))/(l9_103-l9_102));
float l9_107=l9_106;
l9_94=l9_107;
float l9_108=l9_94;
float l9_109=l9_108;
l9_109*=N1_clearValue;
if (N1_reset>0)
{
l9_109=0.0;
}
float l9_110=l9_109;
float l9_111=N1_pressureRange.x;
float l9_112=N1_pressureRange.y;
float4 l9_113=float4(0.0);
float l9_114=l9_110;
float l9_115=l9_111;
float l9_116=l9_112;
float l9_117=0.99998999;
float l9_118=fast::clamp(l9_114,l9_115,l9_116);
float l9_119=l9_115;
float l9_120=l9_116;
float l9_121=0.0;
float l9_122=l9_117;
...
float l9_124=l9_123;
float4 l9_125=float4(1.0,255.0,65025.0,16581375.0)*l9_124;
l9_125=fract(l9_125);
l9_125-=(l9_125.yzww*float4(0.0039215689,0.0039215689,0.0039215689,0.0));
float4 l9_126=l9_125;
float4 l9_127=l9_126;
l9_113=l9_127;
float4 l9_128=l9_113;
N1_pressureOut=l9_128;
param_6=N1_pressureOut;
pressureOut_N1=param_6;
FinalColor=pressureOut_N1;
...
{
float4 l9_140=param_9;
float4 l9_141=float4(0.0);
float4 l9_142=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_143=out.sc_FragData0;
l9_142=l9_143;
}
else
{
float4 l9_144=gl_FragCoord;
float2 l9_145=l9_144.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_166=l9_161;
float2 l9_167=l9_159;
int l9_168=sc_ScreenTextureLayout_tmp;
int l9_169=l9_166;
float l9_170=l9_160;
...
float4 l9_177=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_176.xy,bias(l9_170));
float4 l9_178=l9_177;
float4 l9_179=l9_178;
l9_142=l9_179;
}
float4 l9_180=l9_142;
float3 l9_181=l9_180.xyz;
float3 l9_182=l9_181;
float3 l9_183=l9_140.xyz;
float3 l9_184=definedBlend(l9_182,l9_183,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_141=float4(l9_184.x,l9_184.y,l9_184.z,l9_141.w);
float3 l9_185=mix(l9_181,l9_141.xyz,float3(l9_140.w));
l9_141=float4(l9_185.x,l9_185.y,l9_185.z,l9_141.w);
l9_141.w=1.0;
float4 l9_186=l9_141;
param_9=l9_186;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_187=float4(in.varScreenPos.xyz,1.0);
param_9=l9_187;
}
else
{
...
float l9_189=fast::clamp(abs(l9_188.z),0.0,1.0);
float4 l9_190=float4(l9_189,1.0-l9_189,1.0,1.0);
param_9=l9_190;
}
else
{
float4 l9_191=param_9;
float4 l9_192=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_192=float4(mix(float3(1.0),l9_191.xyz,float3(l9_191.w)),l9_191.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_193=l9_191.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_193=fast::clamp(l9_193,0.0,1.0);
}
l9_192=float4(l9_191.xyz*l9_193,l9_193);
}
else
{
l9_192=l9_191;
...
float4 l9_198=param_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_198.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_198;
return out;
}
} // FRAGMENT SHADER
