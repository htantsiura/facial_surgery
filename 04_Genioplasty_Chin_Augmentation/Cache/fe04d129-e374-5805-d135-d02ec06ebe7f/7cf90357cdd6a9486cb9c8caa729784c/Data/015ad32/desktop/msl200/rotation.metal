...
//texture utexture2D sc_RayTracingHitCasterIdAndBarycentric 0:15:0:25
//texture texture2D sc_RayTracingRayDirection 0:16:0:26
//texture texture2D sc_ScreenTexture 0:18:0:28
//ubo float sc_BonesUBO 0:3:96 {
//sc_Bone_t sc_Bones 0:[1]:96
//float4 sc_Bones.boneMatrix 0:[3]:16
//float4 sc_Bones.normalMatrix 48:[3]:16
//}
//ubo int UserUniforms 0:31:4640 {
//float4 sc_Time 1376
...
//float isActive 4400
//float Port_Input1_N006 4404
//float4 Port_Input1_N007 4416
//float4 Port_Input2_N007 4432
//float Port_RangeMinA_N003 4448
//float Port_RangeMaxA_N003 4452
//float Port_RangeMinB_N003 4456
//float Port_RangeMaxB_N003 4460
//float4 Port_Import_N031 4464
//float4 Port_Import_N032 4480
//float Port_RangeMinA_N034 4496
//float Port_RangeMaxA_N034 4500
//float Port_RangeMinB_N034 4504
//float Port_RangeMaxB_N034 4508
//float2 Port_Import_N038 4512
//float2 Port_Center_N041 4520
//float2 Port_Import_N042 4528
//float Port_Import_N044 4536
//float Port_Import_N047 4540
//float4 Port_Import_N011 4544
//float4 Port_Import_N012 4560
//float Port_RangeMinA_N014 4576
//float Port_RangeMaxA_N014 4580
//float Port_RangeMinB_N014 4584
//float Port_RangeMaxB_N014 4588
//float2 Port_Import_N015 4592
//float2 Port_Center_N016 4600
//float2 Port_Import_N017 4608
//float Port_Import_N019 4616
//float Port_Import_N021 4620
//float Port_Input1_N025 4624
//float Port_Input2_N025 4628
//float depthRef 4632
//}
...
float4 Port_Input1_N007;
float4 Port_Input2_N007;
float Port_RangeMinA_N003;
float Port_RangeMaxA_N003;
float Port_RangeMinB_N003;
float Port_RangeMaxB_N003;
...
float2 Port_Center_N041;
float2 Port_Import_N042;
float Port_Import_N044;
float Port_Import_N047;
float4 Port_Import_N011;
float4 Port_Import_N012;
float Port_RangeMinA_N014;
float Port_RangeMaxA_N014;
float Port_RangeMinB_N014;
float Port_RangeMaxB_N014;
float2 Port_Import_N015;
float2 Port_Center_N016;
float2 Port_Import_N017;
float Port_Import_N019;
float Port_Import_N021;
float Port_Input1_N025;
float Port_Input2_N025;
float depthRef;
};
struct sc_Bone_t
{
...
sampler sc_RayTracingHitCasterIdAndBarycentricSmpSC [[id(25)]];
sampler sc_RayTracingRayDirectionSmpSC [[id(26)]];
...
Output_N1=param_1;
float Output_N2=0.0;
float param_2=(*sc_set0.UserUniforms).isActive;
Output_N2=param_2;
float Output_N6=0.0;
Output_N6=Output_N2*(*sc_set0.UserUniforms).Port_Input1_N006;
float4 Output_N5=float4(0.0);
Output_N5=Output_N1+float4(Output_N6);
float4 Output_N7=float4(0.0);
Output_N7=fast::clamp(Output_N5+float4(0.001),(*sc_set0.UserUniforms).Port_Input1_N007+float4(0.001),(*sc_set0.UserUniforms).Port_Input2_N007+float4(0.001))-float4(0.001);
float ValueOut_N3=0.0;
ValueOut_N3=(((Output_N2-(*sc_set0.UserUniforms).Port_RangeMinA_N003)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N003-(*sc_set0.UserUniforms).Port_RangeMinA_N003)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N003-(*sc_set0.UserUniforms).Port_RangeMinB_N003))+(*sc_set0.UserUniforms).Port_RangeMinB_N003;
...
float2 UVCoord_N86=float2(0.0);
UVCoord_N86=Globals.Surface_UVCoord0;
float2 ValueOut_N34=float2(0.0);
ValueOut_N34=(((UVCoord_N86-float2((*sc_set0.UserUniforms).Port_RangeMinA_N034))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N034-(*sc_set0.UserUniforms).Port_RangeMinA_N034)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N034-(*sc_set0.UserUniforms).Port_RangeMinB_N034))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N034);
float2 Value_N38=float2(0.0);
Value_N38=(*sc_set0.UserUniforms).Port_Import_N038;
float2 CoordsOut_N41=float2(0.0);
CoordsOut_N41=((ValueOut_N34-(*sc_set0.UserUniforms).Port_Center_N041)*Value_N38)+(*sc_set0.UserUniforms).Port_Center_N041;
float2 Value_N42=float2(0.0);
Value_N42=(*sc_set0.UserUniforms).Port_Import_N042;
float Output_N43=0.0;
Output_N43=distance(CoordsOut_N41,Value_N42);
float Value_N44=0.0;
Value_N44=(*sc_set0.UserUniforms).Port_Import_N044;
float Output_N46=0.0;
Output_N46=Output_N43-Value_N44;
float Value_N47=0.0;
Value_N47=(*sc_set0.UserUniforms).Port_Import_N047;
float Output_N48=0.0;
Output_N48=Output_N46/(Value_N47+1.234e-06);
float4 Output_N49=float4(0.0);
Output_N49=mix(Value_N31,Value_N32,float4(Output_N48));
float4 Export_N51=float4(0.0);
Export_N51=Output_N49;
float4 Value_N11=float4(0.0);
Value_N11=(*sc_set0.UserUniforms).Port_Import_N011;
float4 Value_N12=float4(0.0);
Value_N12=(*sc_set0.UserUniforms).Port_Import_N012;
float2 UVCoord_N13=float2(0.0);
UVCoord_N13=Globals.Surface_UVCoord0;
float2 ValueOut_N14=float2(0.0);
ValueOut_N14=(((UVCoord_N13-float2((*sc_set0.UserUniforms).Port_RangeMinA_N014))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N014-(*sc_set0.UserUniforms).Port_RangeMinA_N014)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N014-(*sc_set0.UserUniforms).Port_RangeMinB_N014))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N014);
float2 Value_N15=float2(0.0);
Value_N15=(*sc_set0.UserUniforms).Port_Import_N015;
float2 CoordsOut_N16=float2(0.0);
CoordsOut_N16=((ValueOut_N14-(*sc_set0.UserUniforms).Port_Center_N016)*Value_N15)+(*sc_set0.UserUniforms).Port_Center_N016;
float2 Value_N17=float2(0.0);
Value_N17=(*sc_set0.UserUniforms).Port_Import_N017;
float Output_N18=0.0;
Output_N18=distance(CoordsOut_N16,Value_N17);
float Value_N19=0.0;
Value_N19=(*sc_set0.UserUniforms).Port_Import_N019;
float Output_N20=0.0;
Output_N20=Output_N18-Value_N19;
float Value_N21=0.0;
Value_N21=(*sc_set0.UserUniforms).Port_Import_N021;
float Output_N22=0.0;
Output_N22=Output_N20/(Value_N21+1.234e-06);
float4 Output_N23=float4(0.0);
Output_N23=mix(Value_N11,Value_N12,float4(Output_N22));
float4 Export_N24=float4(0.0);
Export_N24=Output_N23;
float Output_N9=0.0;
Output_N9=Export_N51.x*Export_N24.x;
float Output_N25=0.0;
Output_N25=fast::clamp(Output_N9+0.001,(*sc_set0.UserUniforms).Port_Input1_N025+0.001,(*sc_set0.UserUniforms).Port_Input2_N025+0.001)-0.001;
float Output_N29=0.0;
Output_N29=ValueOut_N3*Output_N25;
float4 Value_N0=float4(0.0);
Value_N0=float4(Output_N7.xyz.x,Output_N7.xyz.y,Output_N7.xyz.z,Value_N0.w);
Value_N0.w=Output_N29;
FinalColor=Value_N0;
float param_3=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_3<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_4=fast::max(param_4,float4(0.0));
float4 param_5=l9_4;
if (sc_ShaderCacheConstant_tmp!=0)
{
