...
Output_N8=Output_N0*(*sc_set0.UserUniforms).Port_Input1_N008;
float Output_N7=0.0;
Output_N7=Output_N0.w;
float4 Value_N6=float4(0.0);
Value_N6=float4(Output_N8.xyz.x,Output_N8.xyz.y,Output_N8.xyz.z,Value_N6.w);
Value_N6.w=Output_N7;
FinalColor=Value_N6;
