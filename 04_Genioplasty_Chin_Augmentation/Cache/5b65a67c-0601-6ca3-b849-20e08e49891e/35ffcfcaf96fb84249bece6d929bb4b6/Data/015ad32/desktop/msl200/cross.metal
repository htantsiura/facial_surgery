...
//float Tweak_N5 4512
//float Port_Value2_N006 4516
//float Port_Value3_N006 4520
//float Port_Value4_N006 4524
//float depthRef 4528
//}
...
float Port_Value3_N006;
float Port_Value4_N006;
float depthRef;
};
struct sc_Bone_t
{
...
float Output_N5=0.0;
float param_1=(*sc_set0.UserUniforms).Tweak_N5;
Output_N5=param_1;
float2 Output_N3=float2(0.0);
Output_N3=UVCoord_N2*float2(Output_N5);
...
Value_N6.x=Output_N0.x;
Value_N6.y=(*sc_set0.UserUniforms).Port_Value2_N006;
Value_N6.z=(*sc_set0.UserUniforms).Port_Value3_N006;
Value_N6.w=(*sc_set0.UserUniforms).Port_Value4_N006;
FinalColor=Value_N6;
