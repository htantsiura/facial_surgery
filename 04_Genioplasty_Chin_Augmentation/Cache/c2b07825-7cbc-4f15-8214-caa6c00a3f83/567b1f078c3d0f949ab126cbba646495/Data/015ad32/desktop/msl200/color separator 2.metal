...
float3 l9_76=float3(Output_N18);
Value_N19=float4(l9_76.x,l9_76.y,l9_76.z,Value_N19.w);
Value_N19.w=(*sc_set0.UserUniforms).Port_Value2_N019;
...
float4 l9_80=fast::max(param_13,float4(0.0));
float4 param_14=l9_80;
if (sc_ShaderCacheConstant_tmp!=0)
{
