    ...
    var ButtonBackToOriginPosition = _classThis = class extends _classSuper {
        ...
        set currentPos(newPos) {
            ...
            if (this._originPos && !this._originPos.equal(newPos)) {
                this._currentScale = this.objectTrf.getLocalScale();
                let buttonScale = new vec3(1 * this._currentScale.x, 1 * this._currentScale.x, 1 * this._currentScale.x);
                this.buttonMoveToOrigin.getTransform().setLocalScale(this._currentScale);
