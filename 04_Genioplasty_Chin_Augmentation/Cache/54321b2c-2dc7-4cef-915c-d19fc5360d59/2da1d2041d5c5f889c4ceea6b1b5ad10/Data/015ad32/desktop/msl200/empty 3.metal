...
float4 param_2=(*sc_set0.UserUniforms).Port_Value1_N000;
...
float4 l9_6=fast::max(param_7,float4(0.0));
float4 param_8=l9_6;
if (sc_ShaderCacheConstant_tmp!=0)
{
