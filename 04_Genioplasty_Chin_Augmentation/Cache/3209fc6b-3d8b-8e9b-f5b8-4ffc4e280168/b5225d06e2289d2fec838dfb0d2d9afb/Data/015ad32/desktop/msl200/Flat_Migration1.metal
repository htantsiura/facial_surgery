...
constant bool baseTexHasSwappedViews [[function_constant(43)]];
...
constant bool opacityTexHasSwappedViews [[function_constant(45)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex [[function_constant(77)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_opacityTex [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_baseTex [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_opacityTex [[function_constant(82)]];
...
constant int baseTexLayout [[function_constant(83)]];
...
constant int opacityTexLayout [[function_constant(85)]];
...
{
main_frag_out out={};
float4 N0_baseColor=float4(0.0);
bool N0_ENABLE_BASE_TEXTURE=false;
bool N0_ENABLE_OPACITY_TEXTURE=false;
float4 N0_Result=float4(0.0);
...
Output_N5=param_1;
float4 Result_N0=float4(0.0);
float4 param_2=Output_N5;
ssGlobals param_4=Globals;
ssGlobals tempGlobals=param_4;
float4 param_3=float4(0.0);
N0_baseColor=param_2;
N0_ENABLE_BASE_TEXTURE=(int(ENABLE_BASE_TEX_tmp)!=0);
N0_ENABLE_OPACITY_TEXTURE=(int(ENABLE_OPACITY_TEX_tmp)!=0);
float4 l9_1;
if (N0_ENABLE_BASE_TEXTURE)
{
float4 l9_2=N0_baseColor;
float2 l9_3=tempGlobals.Surface_UVCoord0;
float2 l9_4=l9_3;
...
int l9_11=l9_6;
int l9_12=baseTexLayout_tmp;
int l9_13=l9_11;
float2 l9_14=l9_4;
bool l9_15=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_16=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_17=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_18=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_19=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_20=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_21=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_22=0.0;
...
float3 l9_87=l9_86;
float3 l9_88=l9_87;
float4 l9_89=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_88.xy,bias(l9_82));
float4 l9_90=l9_89;
if (l9_20)
{
...
int l9_104=l9_99;
int l9_105=opacityTexLayout_tmp;
int l9_106=l9_104;
float2 l9_107=l9_97;
bool l9_108=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_109=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_110=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_111=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_112=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_113=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_114=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_115=0.0;
...
float3 l9_181=l9_180;
float4 l9_182=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_181.xy,bias(l9_175));
...
float l9_186=l9_94;
N0_Result=float4(l9_93.xyz,l9_186);
param_3=N0_Result;
Result_N0=param_3;
FinalColor=Result_N0;
...
{
float4 l9_187=gl_FragCoord;
float2 l9_188=floor(mod(l9_187.xy,float2(4.0)));
float l9_189=(mod(dot(l9_188,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_5<l9_189)
{
discard_fragment();
}
...
float4 l9_190=fast::max(param_6,float4(0.0));
float4 param_7=l9_190;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_193=fast::clamp(l9_192.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_193=fast::clamp(dot(l9_192.xyz,float3(l9_192.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_193=(1.0-dot(l9_192.xyz,float3(0.33333001)))*l9_192.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_193=(1.0-fast::clamp(dot(l9_192.xyz,float3(1.0)),0.0,1.0))*l9_192.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_193=fast::clamp(dot(l9_192.xyz,float3(1.0)),0.0,1.0)*l9_192.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_193=fast::clamp(dot(l9_192.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_193=dot(l9_192.xyz,float3(0.33333001))*l9_192.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_193=1.0-fast::clamp(dot(l9_192.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_194=l9_193;
float l9_195=l9_194;
float l9_196=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_195;
float3 l9_197=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_191.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_198=float4(l9_197.x,l9_197.y,l9_197.z,l9_196);
param_8=l9_198;
}
else
{
...
{
float4 l9_199=param_8;
float4 l9_200=float4(0.0);
float4 l9_201=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_202=out.sc_FragData0;
l9_201=l9_202;
}
else
{
float4 l9_203=gl_FragCoord;
float2 l9_204=l9_203.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_209=l9_208;
int l9_210=l9_209;
float3 l9_211=float3(l9_205,0.0);
int l9_212=l9_207;
int l9_213=l9_210;
if (l9_212==1)
{
l9_211.y=((2.0*l9_211.y)+float(l9_213))-1.0;
}
float2 l9_214=l9_211.xy;
l9_206=l9_214;
}
else
{
...
int l9_225=l9_220;
float2 l9_226=l9_218;
int l9_227=sc_ScreenTextureLayout_tmp;
int l9_228=l9_225;
float l9_229=l9_219;
...
if (l9_231==0)
{
l9_233=float3(l9_230,0.0);
}
else
{
if (l9_231==1)
{
l9_233=float3(l9_230.x,(l9_230.y*0.5)+(0.5-(float(l9_232)*0.5)),0.0);
}
else
{
l9_233=float3(l9_230,float(l9_232));
}
}
float3 l9_234=l9_233;
float3 l9_235=l9_234;
float4 l9_236=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_235.xy,bias(l9_229));
float4 l9_237=l9_236;
float4 l9_238=l9_237;
l9_201=l9_238;
}
float4 l9_239=l9_201;
float3 l9_240=l9_239.xyz;
float3 l9_241=l9_240;
float3 l9_242=l9_199.xyz;
float3 l9_243=definedBlend(l9_241,l9_242,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_200=float4(l9_243.x,l9_243.y,l9_243.z,l9_200.w);
float3 l9_244=mix(l9_240,l9_200.xyz,float3(l9_199.w));
l9_200=float4(l9_244.x,l9_244.y,l9_244.z,l9_200.w);
l9_200.w=1.0;
float4 l9_245=l9_200;
param_8=l9_245;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_246=float4(in.varScreenPos.xyz,1.0);
param_8=l9_246;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_247=gl_FragCoord;
float l9_248=fast::clamp(abs(l9_247.z),0.0,1.0);
float4 l9_249=float4(l9_248,1.0-l9_248,1.0,1.0);
param_8=l9_249;
}
else
{
float4 l9_250=param_8;
float4 l9_251=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_251=float4(mix(float3(1.0),l9_250.xyz,float3(l9_250.w)),l9_250.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_252=l9_250.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_252=fast::clamp(l9_252,0.0,1.0);
}
l9_251=float4(l9_250.xyz*l9_252,l9_252);
}
else
{
l9_251=l9_250;
...
float4 l9_257=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_257.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_257;
return out;
}
} // FRAGMENT SHADER
